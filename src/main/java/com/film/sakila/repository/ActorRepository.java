...
public interface ActorRepository extends JpaRepository<Actor, Integer> {
    @Query(value = "select new com.film.sakila.data.InformationActor(a.firstName, a.lastName) " +
            "from Actor a ")
    List<InformationActor> getFirstAndLastNameActor();
    @Query(value = "select new com.film.sakila.data.ActorParticipatedMoreThanTwentyFilms(a.firstName,a.lastName, count(f.id.actorId)) from FilmActor f " +
